        ...
        return `
            <li class="tab-resellers__ranking-item">
                ...
                <div class="tab-resellers__ranking-infos">
                    ...
                    <span class="tab-resellers__ranking-demand">
                        ${item.ordersCount} pedidos <span class="tab-resellers__ranking-percent-num">${item.percentage}</span>
                        <svg class="tab-resellers__ranking-percent-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
